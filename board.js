...
if (typeof window.rebuildGrid === "function") {
    window.rebuildGrid();
        ...
        i++;
        window.demoTimer = setTimeout(playNext, 600);
    }
...
// ★ モード切り替えボタン（人間 vs 人間）
document.getElementById("modeHumanVsHuman").addEventListener("click", () => {
    gameMode = "human_vs_human";
    console.log("モード：人間 vs 人間");
